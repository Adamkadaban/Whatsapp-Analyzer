  ...
  return (
    <div className="card empty-result" role="status" aria-live="polite">
      ...
      <p className="text-muted m-0 empty-result-lead">
        We read your file, but it doesn&rsquo;t look like it contains any WhatsApp
        messages. A few things worth checking:
      </p>
      <ul className="empty-result-list text-muted">
        <li>
          Make sure it&rsquo;s a chat{" "}
          <strong className="text-white">exported from WhatsApp</strong> &mdash; a{" "}
          <code className="empty-result-code">.txt</code> file, or a{" "}
        ...
        <li>
          Exporting <strong className="text-white">Without Media</strong> is fine &mdash;
          the messages are kept as plain text.
        </li>
      </ul>
