...
const buckets = [createMockPersonBuckets("Alice", 100), createMockPersonBuckets("Bob", 80)];
...
describe("ColorModal accessibility", () => {
  it("exposes a labelled dialog", () => {
    ...
    expect(screen.getByText("Configure user colors")).toHaveAttribute("id", "color-modal-title");
  });
